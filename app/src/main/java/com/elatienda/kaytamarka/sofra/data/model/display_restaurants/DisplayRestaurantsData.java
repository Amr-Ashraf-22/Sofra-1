...
public class DisplayRestaurantsData {
    ...
    @Expose
    private GeneralResponseNotPaginatedData region;
    ...
    public GeneralResponseNotPaginatedData getRegion() {
        return region;
    }

    public void setRegion(GeneralResponseNotPaginatedData region) {
        this.region = region;
    }
